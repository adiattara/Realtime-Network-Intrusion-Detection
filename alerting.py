...
BOT_EMAIL = os.getenv('BOT_EMAIL', 'raffleromain@gmail.com')         # Change en variable d'environnement ou dans .env
BOT_APP_PASSWORD = os.getenv('BOT_APP_PASSWORD', 'dqwn egxt wggg qmvl')  # Jamais en clair en prod !
